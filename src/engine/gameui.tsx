...
export class Test extends Component<Props, State> {
    ...
    render(): JSXElement {
        return(
            <panel height="70" width="300" color="#1f22dc" top="685" left="1130" >
                <panel z_index="1" height="50" width="50" color="#1f22dc" img="./data/textures/cottage.png">
                    <label z_index="2" top="10" color="#1f22dc" contents={this.props.ticks.toString()}></label>
                </panel>
                <panel left="-100" height="50" width="50" color={this.props.color}
